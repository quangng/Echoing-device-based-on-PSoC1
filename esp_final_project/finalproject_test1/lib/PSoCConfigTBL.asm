...
export LoadConfigTBL_finalproject_test1_Bank1
export LoadConfigTBL_finalproject_test1_Bank0
export LoadConfigTBL_finalproject_test1_Ordered
AREA lit(rom, rel)
LoadConfigTBL_finalproject_test1_Bank0:
...
;  Global Register values Bank 0
	...
	db		ffh
LoadConfigTBL_finalproject_test1_Bank1:
;  Instance name LCD, User Module LCD
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB03)
...
LoadConfigTBL_finalproject_test1_Ordered:
;  Ordered Global Register values
	M8C_SetBank0
	mov	reg[00h], 00h		; Port_0_Data register (PRT0DR)
	M8C_SetBank1
	mov	reg[00h], 02h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], f9h		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], e9h		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], 12h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
