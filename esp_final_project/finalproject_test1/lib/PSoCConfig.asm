...
export LoadConfig_finalproject_test1
export _LoadConfig_finalproject_test1
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_finalproject_test1
	lcall	LoadConfigTBL_finalproject_test1_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration finalproject_test1
;
;    Load configuration registers for finalproject_test1.
...
;               CUR_PP
;
_LoadConfig_finalproject_test1:
 LoadConfig_finalproject_test1:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_finalproject_test1_Bank0
    mov     X, <LoadConfigTBL_finalproject_test1_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_finalproject_test1_Bank1
    mov     X, <LoadConfigTBL_finalproject_test1_Bank1
